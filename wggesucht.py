def main():
    ...
    st.markdown("<a href="https://airtable.com/app5p6oAnyclgWPM9/pagFlz6Ae0kMjHNNu?RwACb=rec5EKs8ZMeOsygjH&vH2xA=reczG0JNSvJCezJDx">Click here to go the disposals dashboard</a>", unsafe_allow_html=True)
