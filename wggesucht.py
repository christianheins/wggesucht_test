def main():
    ...
    if selected == "🏘️ Apartments":
        ...
        with col2:
            ...
            st.metric("25% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["25%"]["Größe"]))
            st.metric("50% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["50%"]["Größe"]))
            st.metric("75% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["75%"]["Größe"]))
        ...
        with col3:
            ...
            st.metric("25% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["25%"]["EUR / SQM"]))
            st.metric("50% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["50%"]["EUR / SQM"]))
            st.metric("75% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["75%"]["EUR / SQM"]))
        ...
        with col4:
            ...
            st.metric("25% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["25%"]["Lease term"]))
            st.metric("50% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["50%"]["Lease term"]))
            st.metric("75% of the leases are up to", value="{:,.0f} €".format(df_statistics.loc["75%"]["Lease term"]))
